...
const roboto_bold = Roboto({ subsets: ['latin'], weight: '700' });
    ...
    <div className="pt-20 relative text-primary flex flex-col">
      <div className="h-3 w-32 bg-secondary-muted mx-auto relative z-1 mb-24">
        <h2 className="text-5xl font-extrabold tracking-wider absolute -bottom-0 right-2 text-white">
          ...
          <div className="flex text-white font-extrabold tracking-wider relative mb-40 sm:mb-24">
          <AnimateLeftOnView>
      ...
      <div className="flex text-white font-extrabold tracking-wider relative ml-auto">
        <AnimateRightOnView>
